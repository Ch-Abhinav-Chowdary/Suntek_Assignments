...
const products = [
              {
                ...
                price: 250,
                brand: "Apple",
                description: "Active noise cancellation with adaptive transparency and immersive spatial audio.",
...
const Products = () => {
  return (
    <div className='flex flex-wrap gap-6 justify-center p-5'>
      {
        products.map((prodObj) => <Product key={prodObj.productId} className=" " {...prodObj} />)
      }
    </div>
  )
}
