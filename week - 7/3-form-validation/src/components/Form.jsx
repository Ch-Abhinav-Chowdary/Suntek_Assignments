  ...
  return (
    ...
    <div className="w-full text-center">
      ...
      <form className="flex flex-col p-5 gap-3 justify-center items-center" onSubmit={handleSubmit(onSubmit)}>
        <input {...register("firstname", {required:true, minLength:4,maxLength:6})} className="border-2 w-[60%] bg-cyan-400 rounded-2xl" type="text" placeholder="Enter firstName" />
        {
            errors.firstname?.type === "required" && <p className="text-red-500">First name is mandatory</p>
        }
        {
        ...
        <input {...register("lastname",{required:true, minLength:4,maxLength:6})} className="border-2 w-[60%] bg-cyan-400 rounded-2xl" type="text" placeholder="Enter LastName" />
        {
            errors.lastname?.type === "required" && <p className="text-red-500">Last name is mandatory</p>
        }
        {
        ...
        <input {...register("email",{required:true})} className="border-2 w-[60%] bg-cyan-400 rounded-2xl" type="email" placeholder="Enter Email" />
        {
            errors.email?.type === "required" && <p className="text-red-500">Email is required</p>
        }
        <input {...register("dob",{required:true})} className="border-2 w-[60%] bg-cyan-400 rounded-2xl" type="date" placeholder="Enter DOB" />
        {
            errors.dob?.type === "required" && <p className="text-red-500">Date of birth is required</p>
        }
        {
            errors.dob?.type === "manual" && <p className="text-red-500">{errors.dob.message}</p>
        }
        <button className="bg-orange-400 w-[20%] py-3" type="submit">Add New User</button>
      </form>
      ...
      <table className="m-auto w-[80%] bg-purple-400 p-6">
        <thead className="">
            <tr className="">
